            ...
            <div className="clients-logos text-center col-12">
              <ul className="row text-center clearfix">
                ...
                >
                  <div className="brand-logo">
                    <img
                      src="images/client/clients-6.png"
                      alt="clients"
                      className="img-fluid"
                    />
                  </div>
                ...
                >
                  <div className="brand-logo">
                    <img
                      src="images/client/clients-7.png"
                      alt="clients"
                      className="img-fluid"
                    />
                  </div>
                ...
                >
                  <div className="brand-logo">
                    <img
                      src="images/client/clients-8.png"
                      alt="clients"
                      className="img-fluid"
                    />
                  </div>
                ...
                >
                  <div className="brand-logo">
                    <img
                      src="images/client/clients-9.png"
                      alt="clients"
                      className="img-fluid"
                    />
                  </div>
                ...
                >
                  <div className="brand-logo">
                    <img
                      src="images/client/clients-10.png"
                      alt="clients"
                      className="img-fluid"
                    />
                  </div>
                ...
                >
                  <div className="brand-logo">
                    <img
                      src="images/client/clients-11.png"
                      alt="clients"
                      className="img-fluid"
                    />
                  </div>
                ...
                >
                  <div className="brand-logo">
                    <img
                      src="images/client/clients-12.png"
                      alt="clients"
                      className="img-fluid"
                    />
                  </div>
                ...
                >
                  <div className="brand-logo">
                    <img
                      src="images/client/clients-13.png"
                      alt="clients"
                      className="img-fluid"
                    />
                  </div>
                ...
                >
                  <div className="brand-logo">
                    <img
                      src="images/client/clients-14.png"
                      alt="clients"
                      className="img-fluid"
                    />
                  </div>
